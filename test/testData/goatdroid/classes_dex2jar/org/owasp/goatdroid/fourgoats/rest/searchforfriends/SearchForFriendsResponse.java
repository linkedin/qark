...
public class SearchForFriendsResponse
{
  ...
  public static ArrayList<HashMap<String, String>> parseSearchForFriendsResponse(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (JSONException localJSONException1)
      {
        ...
        try
        {
          ...
          if (localJSONObject2.getJSONObject("users").has("userID")) {
            localHashMap2.put("userID", (String)localJSONObject2.getJSONObject("users").get("userID"));
          }
