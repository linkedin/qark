...
public class RestClient {
    ...
    public RestClient(String string2) {
        this.url = string2;
     ...
     * Lifted jumps to return sites
     */
    private void executeRequest(HttpUriRequest httpUriRequest, String string2, Context context) {
        ...
        try {
            ...
            this.response = RestClient.convertStreamToString(inputStream);
            inputStream.close();
            return;
        }
    ...
    public void Execute(RequestMethod var1_1, Context var2_2) throws Exception {
        block0 : switch (RestClient.$SWITCH_TABLE$org$owasp$goatdroid$fourgoats$requestresponse$RequestMethod()[var1_1.ordinal()]) {
            default: {
                return;
            }
            case 1: {
